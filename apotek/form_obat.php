...
$Sub_Total=$POST['Sub_Total'];
	...
	$query= mysql_query("insert into t_obat values('$Kode_Obat','$Nama_Obat','$Jenis_Obat','$Kategori','$Harga','$Jumlah')","
		insert into t_detailobat values('$Kode_Obat','$Harga','$Kategori','$Dosis','$Sub_Total')") or die (mysql_error());
	if($query){
		echo "Data Tersimpan";
		}else{
